"""
Code for building and training MLP model of Robot 1 (same case for robot 2 by analogy) 
...
# prepare the data
path = '/home/hussein/Desktop/Multi-agent-path-planning/Two Robots Topology Graph/GNN Model/MLP_UniCycle/dataset_robot1.csv'
